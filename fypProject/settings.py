...
SECRET_KEY = 'django-insecure-!g%rlr55w-@opi(&#uh2z7j!bzcoep#2((j)t7)cgrqk=$0bhz'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR/"templates",
                 ...
                 os.path.join(BASE_DIR, 'virt/lib/python3/site-packages/django/contrib/auth/templates/registration'),              
                 ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
JAZZMIN_SETTINGS = {
    ...
    "hide_models": ["url.Support"],

    # List of apps (and/or models) to base side menu ordering off of (does not need to contain all apps/models)
    "order_with_respect_to": ["auth", "books", "books.author", "books.book", "custom"],
    ...
    "icons": {
        ...
        "udsm_risk_register.Mitigations": "fas fa-user", 
        # "udsm_risk_register.RiskDetails": "fa-solid fa-circle-info",
        "udsm_risk_register.Risks": "",
        "udsm_risk_register.Units": "fas fa-building",
        "udsm_risk_register.Users": "fas fa-user",
